...
your own class by replacing the CakeResponse used in app/webroot/index.php.
...
To respond with a file that does not exist on a disk, for instance when you generate pdf or ics on the fly, and want
to serve the generated string as a file you can do that by using::
